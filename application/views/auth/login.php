                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gary-900 mb-4">Halaman Login</h1>
                                </div>
                                ...
                                <form class="user" method="post" action="<?= base_url('auth/cek_login'); ?>">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="email" aria-describedby="emailHelp" name="email" placeholder="Masukkan Alamat Email">
                                    </div>
                                    <br>
                                    <div class="form-group">
                                    ...
                                    <br>
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-primary btn-user btn-block center">Login</button>
                                    </div>
                                </form> -->
                                <hr>
                                <div class="text-center">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-5 rounded-4 mt-5">
                                    <div class="card-center"><h3 class="text-center font-weight-light my-4">Login</h3></div>
                                    <div class="card-body">
                                        <form>
